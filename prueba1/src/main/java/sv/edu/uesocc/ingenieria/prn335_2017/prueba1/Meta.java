...
@NamedQueries({
    ...
    , @NamedQuery(name = "Meta.findByActivo", query = "SELECT m FROM Meta m WHERE m.activo = :activo")
...
public class Meta implements Serializable {
    ...
    @JoinTable(name = "post_meta", joinColumns = {
        @JoinColumn(name = "id_meta", referencedColumnName = "id_meta")}, inverseJoinColumns = {
    ...
    public Meta(Integer idMeta, String nombre) {
        this.idMeta = idMeta;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.prueba1.Meta[ idMeta=" + idMeta + " ]";
    }
